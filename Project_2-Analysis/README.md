...
This project focuses on data, exploring the most optimal jobs and skills in the data science market. What skills do top employers request and what salaries can job seekers expect?

### Questions to Analyze

To understand the data science job market, let's ask ourselves the following questions:
...
The dataset used for this project contains real-world data science job information from 2023. The dataset is available in the 0_Resources folder, which provides a foundation for analyzing data using Excel. 
...
I hope this project is practical for data professionals and provides an overview of the skills needed for higher-paying roles.
